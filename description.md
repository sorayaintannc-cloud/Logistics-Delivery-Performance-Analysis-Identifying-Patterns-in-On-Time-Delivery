...
## Repository Outline
```
1. description.md - Berisi deskripsi umum project, tujuan, metode, dan teknologi yang digunakan.
2. P2M3_soraya_intan_DAG.py - Script DAG Apache Airflow untuk automasi proses ETL (fetch, cleaning, load ke Elasticsearch).
3. P2M3_soraya_intan_data_clean.csv - Dataset yang telah melalui proses data cleaning dan siap digunakan untuk analisis.
4. P2M3_soraya_intan_data_raw.csv - Dataset mentah sebelum dilakukan proses pembersihan data.
5. P2M3_soraya_intan_ddl.txt - Berisi syntax DDL dan DML untuk pembuatan tabel dan insert data ke PostgreSQL.
6. P2M3_soraya_intan_GX.ipynb - Notebook untuk validasi data menggunakan Great Expectations.
7. P2M3_soraya_intan_DAG_graph.png - Visualisasi graph DAG yang menunjukkan alur pipeline Airflow.
8. P2M3_soraya_intan_conceptual.txt - Jawaban untuk soal conceptual terkait NoSQL, Airflow, dan data processing.
